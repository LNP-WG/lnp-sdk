const lnp = require('../../wrappers/ecmascript/lnp')
...
function main() {
    let lnpNode = new lnp.Node(DATA_DIR, "testnet")
    console.log("LNP node runtime has started")
    ...
    let consignmentFile = DATA_DIR + '/consignment.lnp'
    ...
    try {
        lnpNode.validate(consignmentPath)
...
console.log("LNP integration demo")
try {
    main()
} catch (e) {
