package org.lnpbp.lnp;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;

import org.lnpbp.lnp.model.OutPoint;
import org.lnpbp.lnp.model.OutpointCoins;
import org.lnpbp.lnp_autogen.COpaqueStruct;
import org.lnpbp.lnp_autogen.lnp;
...
public class Runtime {
    ...
    public Runtime(final String datadir, final String network, final String electrum) throws RuntimeException {
        ...
        try {
            this.runtime = lnp.lnp_node_run(datadir, network, electrum, (byte) 3);
        } catch (Exception e) {
    ...
    public void issue(final String ticker, final String name, final String description, final byte precision, final List<OutpointCoins> allocations, final HashSet<OutpointCoins> inflation, final OutPoint renomination, final OutPoint epoch) throws RuntimeException {
        try {
            ...
            lnp.lnp_node_fungible_issue(this.runtime, this.network, ticker, name, description, precision, allocationsStr, inflationStr,
    ...
    public void transfer(List<String> inputs, List<OutpointCoins> allocate, String invoice, String prototype_psbt, String consignment_file, String transaction_file) throws RuntimeException {
        try {
            ...
            lnp.lnp_node_fungible_transfer(this.runtime, inputsStr, allocateStr, invoice, prototype_psbt, consignment_file, transaction_file);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public String assetAllocations(String contractId) throws RuntimeException {
        try {
            return lnp.lnp_node_fungible_asset_allocations(this.runtime, contractId);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public String outpointAssets(String outpoint) throws RuntimeException {
        try {
            return lnp.lnp_node_fungible_outpoint_assets(this.runtime, outpoint);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
